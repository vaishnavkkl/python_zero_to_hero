...
# print(customer.get("birth","march"))# adding default value to the dictionary
...
# welcome(first_name=name, last_name='m')
...
#
#         @classmethod
#         def infora(cls): #using class variables important
#             return cls.school
#
#         @staticmethod
#         def college():
...
# string_cases = int(input())
# for i in range(string_cases):
#     strings = input()
#     even = ''
#     odd = ''
